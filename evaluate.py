...
def main(dataset_type, root_dataset, clazz, crowd, checkouts, device, resized_size, batch_size, frequency, to_evaluate):
    ...
    utools.file.check_directory(checkouts)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Evaluating trained Mask R-CNN model.')
